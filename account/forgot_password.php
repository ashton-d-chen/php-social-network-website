...
<h1> <?php echo $words['reset'] . ' ' . $words['password'] ?> </h1>
<p>Enter your email address below and your password will be reset.</p> 
<form action="forgot_password.php" method="post">
	<fieldset>
	<p><b><?php echo $words['email']; ?> </b> <input type="text" name="email" size="20" maxlength="40" value="<?php if (isset($_POST['email'])) echo $_POST['email']; ?>" /></p>
	</fieldset>
	<div align="center"><input type="submit" name="submit" value=<?php echo $words['reset']; ?>  /></div>
